...
- If the 'audit_report.md' or feedback indicates MISSING TESTS, you MUST generate `test_*.py` files.
- Use `pytest` style tests.
- Create tests BEFORE or WHILE fixing the code to ensure validity.
